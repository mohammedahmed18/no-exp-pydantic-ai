...
def _customize_tool_def(transformer: type[JsonSchemaTransformer], t: ToolDefinition):
    ...
    # Only include strict if it needs to be updated
    strict_value = schema_transformer.is_strict_compatible if t.strict is None else t.strict
    # Do one replace instead of two
    return replace(t, parameters_json_schema=parameters_json_schema, strict=strict_value)
